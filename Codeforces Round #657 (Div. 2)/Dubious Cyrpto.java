...
/*
    Solution Created: 02:34:16 20/07/2020
...
public class Main {
	public static void solve(Reader in, Writer out) {
		int t = in.nextInt();
		while(t-->0) {
			long l = in.nextLong(), r = in.nextLong(), m = in.nextLong();
			for(long a = l; a<=r; a++) {
				long n1 = Math.max(1,m/a);
				long n2 = m/a+1;
				long d1 = m-n1*a,d2 = m-n2*a;
				long b,c;
