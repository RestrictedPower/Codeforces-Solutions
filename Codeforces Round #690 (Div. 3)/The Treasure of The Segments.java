...
/*
    Solution Created: 02:09:33 16/12/2020
...
public class Main {
	public static void solve(Reader in, Writer out) {
		...
		while(t-->0){
			int n = in.nextInt();
			Seg1[] a = new Seg1[n]; // Sorted by r of [l, r]
			Seg2[] b = new Seg2[n]; // Sorted by l of [l, r]
			for(int i = 0; i<n; i++){
