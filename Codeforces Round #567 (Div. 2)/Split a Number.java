...
/*
    Solution Created: 06:11:58 05/07/2019
...
public class Main {
	public static void solve(Reader in, Writer out) {
		...
		String s = in.next();
		int l,r;
		for(l = n/2; l>=0; l--) if(s.charAt(l)!='0') break;
		for(r = n/2+1; r<n; r++) if(s.charAt(r)!='0') break;
		BigInteger ans = new BigInteger("-1");
		for(Integer i : new int[] {l,r}) {
			if(i==0||i==n) continue;
			String part1 = s.substring(0, i);
			String part2 = s.substring(i,n);
			BigInteger s1 = new BigInteger(part1);
			BigInteger s2 = new BigInteger(part2);
			BigInteger su = s1.add(s2);
			if(ans.toString().equalsIgnoreCase("-1")||ans.compareTo(su)>0) ans = su;
		}
