...
/*
    Solution Created: 19:29:22 09/05/2020
...
public class Main {
	...
	public static void solve(Reader in, Writer out) {
		...
		while(t-->0) {
			...
			if(n0==0 && n2 == 0) {
				for(int i = 0; i<n1+1; i++) ans.add(i%2==0?0:1);
			}else if(n1==0) {
				if(n0!=0)
				for(int i = 0; i<n0+1; i++) ans.add(0);
				if(n2!=0)
				for(int i = 0; i<n2+1; i++) ans.add(1);
			}else if(n2==0) {
				for(int i = 0; i<n0+1; i++) ans.add(0);
				for(int i = 0; i<n1; i++) ans.add(i%2==1?0:1);
			}else if(n0==0) {
				for(int i = 0; i<n2+1; i++) ans.add(1);
				for(int i = 0; i<n1; i++) ans.add(i%2==0?0:1);
			}else { // All greater
				if(n0!=0)
				for(int i = 0; i<n0+1; i++) ans.add(0);
				if(n2!=0)
