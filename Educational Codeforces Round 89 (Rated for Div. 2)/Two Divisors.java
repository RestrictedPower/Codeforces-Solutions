...
/*
    Solution Created: 09:01:35 14/06/2020
    Custom Competitive programming helper.
*/

public class Main {
	static int[] divs = new int[10000001];
	public static void solve(Reader in, Writer out) {
		int n = in.nextInt();
		for(int i = 2; i<10000001; i++) {
			if(divs[i]!=0) continue;
			for(int j = 0; j<10000001; j+=i) if(divs[j]==0) divs[j] = i;
		}
		...
		for(int i = 0; i<n; i++) out.print(a1[i]+" ");
		out.println();
		for(int i = 0; i<n; i++) out.print(a2[i]+" ");
	}
