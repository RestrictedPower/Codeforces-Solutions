...
/*
    Solution Created: 18:09:29 04/09/2020
...
public class Main {
	public static void solve(Reader in, Writer out) {
		...
		while(t-->0) {
			...
			int dif = y-x;
			ArrayList<Integer> divs = getDivs(dif);
			ArrayList<Integer> ans = new ArrayList<Integer>();
			int ansMaxInt = Integer.MAX_VALUE;
			for(Integer div : divs) {
				...
				if(test.get(n-1)<ansMaxInt){
					ansMaxInt = test.get(n-1);
					ans = test;
				}
			}
	...
	public static ArrayList<Integer> getDivs(int x) {
