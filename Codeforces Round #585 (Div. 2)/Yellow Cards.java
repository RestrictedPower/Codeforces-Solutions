...
/*
    Solution Created: 14:38:55 15/09/2019
    Custom Competitive programming helper.
*/
public class Main {
	public static void solve(Reader in, Writer out) {
		int a1 = in.nextInt(), a2 = in.nextInt(), k1 = in.nextInt(), k2 = in.nextInt(), n = in.nextInt();
		int nrem = n-(a1*(k1-1) + a2*(k2-1));
		int ans1 = Math.max(0, nrem);
		int ans2 = 0;
		if(k1>k2) {
			int tmp = k1;
			k1 = k2;
