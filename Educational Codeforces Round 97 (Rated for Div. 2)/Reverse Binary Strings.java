...
/*
    Solution Created: 14:03:50 28/10/2020
...
public class Main {
	...
	public static int min(char[] a, int n) {
		int[] vals = new int[n];
		for(int i = 0; i<n; i++) vals[i] = (a[i]-'0'+i)%2;
		int ans0 = 0, ans1 = 0, c0 = 0, c1 = 0;
		for(int i = 0; i<n; i++) {
			if(vals[i]==1) {
				c1++;
				if(c0!=0) ans0++;
	...
	public static int min2(char[] a, int n) {
