...
/*
    Solution Created: 15:41:46 12/05/2020
...
public class Main {
	...
	public static int firstDiv(int v) {
		int firstDiv = 2;
		for(firstDiv = 2; firstDiv*firstDiv<=v; firstDiv++) if(v%firstDiv==0) break;
		if(v%firstDiv!=0) firstDiv = v;
		return firstDiv;
	}
