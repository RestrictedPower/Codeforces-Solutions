...
/*
    Solution Created: 15:15:31 16/05/2020
...
public class Main {
	...
	public static int minDig(long n) {
		String s = n+"";
		int ans = 9;
		for(char c : s.toCharArray()) ans = Math.min(ans, c-'0');
		return ans;
	}
	public static int maxDig(long n) {
		String s = n+"";
		int ans = 0;
		for(char c : s.toCharArray()) ans = Math.max(ans, c-'0');
		return ans;
	}
