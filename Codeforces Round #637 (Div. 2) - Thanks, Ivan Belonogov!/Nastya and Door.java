...
/*
    Solution Created: 18:41:20 23/04/2020
...
public class Main {
	...
	public static void solve(Reader in, Writer out) {
		...
		while(t-->0) {
			...
			out.println((peeks+1)+" "+(l+1));
		}
	}
	public static int getPeeks(int l, int r) {
		return ps[r]-ps[l-1];
	}
	public static boolean isPeak(int i) {
