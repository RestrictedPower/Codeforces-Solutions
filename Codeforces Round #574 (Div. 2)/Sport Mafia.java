...
/*
    Solution Created: 04:06:09 18/07/2019
...
public class Main {
	...
	static long t(int totalMoves, int finalCandies, int eatMoves) {
		int candiesToComplete = finalCandies + eatMoves;
		long movesLeft = totalMoves - eatMoves;
		long candiesAdded = (movesLeft*(movesLeft+1))/2;
		return candiesToComplete - candiesAdded;
	}
